...
export const articles: readonly Article[] = [
  {
    ...
    category: "Đất đai",
    imageUrl: "https://img.lsvn.vn/resize/C1MObpz_eHw5R6URGRdL1g2/upload/2025/09/22/163464-638941381187663956-11415882.png",
    imageAlt: "Ảnh minh họa.",
    excerpt: `Dự thảo Luật sửa đổi, bổ sung một số điều của Luật Đất đai do Bộ Nông nghiệp và Môi trường gửi Bộ Tư pháp thẩm định ngày 14/8/2025 đề xuất bổ sung các khoản 33, 34 và 35 vào Điều 79 về thu hồi đất để phát triển kinh tế – xã hội vi`,
    bodyParagraphs: [
    `Dự thảo Luật sửa đổi, bổ sung một số điều của Luật Đất đai do Bộ Nông nghiệp và Môi trường gửi Bộ Tư pháp thẩm định ngày 14/8/2025 đề xuất bổ sung các khoản 33, 34 và 35 vào Điều 79 về thu hồi đất để phát triển kinh tế – xã hội vì lợi ích quốc gia, công cộng như sau:`,
  ...
  },
  {
    ...
    excerpt: `1. Bối cảnh chính sách và thể chế hóa`,
    bodyParagraphs: [
  ...
  },
  {
    ...
    imageAlt: "Ảnh minh họa.",
    excerpt: `Tóm tắt nội dung vụ án`,
    bodyParagraphs: [
    ...
    `Đoàn Luật sư TP. HCM`,
    `Các tin khác`,
    `Góc nhìn của luật sư: Từ chuyện “gà lôi” đến tính nhân văn, lòng nhân ái trong xét xử hình sự`,
    `Từ vụ án gà lôi trắng: Trình tự áp dụng văn bản pháp luật theo quy định`,
    `Vụ án nuôi gà lôi: Quy trình kháng nghị phúc thẩm như thế nào?`,
    `Nhân vụ mua bán gà lôi trắng, bàn về mức hình phạt!`,
    ...
    `PVTT tại khu vực ĐBSCL: Số 284, đường Võ văn Kiệt, phường Bình Thuỷ, TP. Cần Thơ`
    ],
    attribution: articleSourceName,
    originalLinkLabel: articleOriginalLinkLabel,
  },
  {
    ...
    imageAlt: "Ảnh minh họa.",
    excerpt: `1. Trích yếu Án lệ số 13/2017/AL`,
    bodyParagraphs: [
  ...
  },
  {
    ...
    imageAlt: "Ảnh minh họa.",
    excerpt: `Ngày 11/6/2025, Chính phủ đã ban hành Nghị định số 121/2025/NĐ-CP về phân quyền, phân cấp trong lĩnh vực quản lý nhà nước của Bộ Tư pháp (Nghị định 121/2025/NĐ-CP). Tại Điều 9 và Điều 10 Nghị định này quy định phân quyền cấp và th`,
    bodyParagraphs: [
  ...
  },
  {
    ...
    imageAlt: "Ảnh minh họa.",
    excerpt: `Trong bài viết này, tác giả không tập trung xem xét hình phạt tử hình theo các mục đích hình sự truyền thống như trừng trị, răn đe hay phòng ngừa chung. Thay vào đó, bài viết tập trung phân tích dưới góc độ hợp tác quốc tế về dẫn `,
    bodyParagraphs: [
    ...
    `Hành vi tàng trữ, vận chuyển, lưu hành tiền giả sẽ bị xử lý như thế nào?`,
    `Hướng dẫn thực hiện thủ tục thu, nộp đảng phí trực tuyến`,
    `Tổng Biên tập: Thạc sĩ Đặng Ngọc Luyến`,
    `Phó Tổng Biên tập: TS. LS. Liêu Chí Trung`,
    `Phó Tổng Biên tập: Luật sư Trần Mạnh Quyết`
    ],
